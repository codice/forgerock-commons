...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.recto.style" text-align="left" margin-left="-0.5in">
<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="d:title" mode="book.titlepage.recto.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.recto.style" text-align="left" font-weight="bold" font-size="20pt" font-family="DejaVuSans">
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.recto.style" text-align="left" font-weight="regular" font-size="12pt" space-before="9pt" font-family="DejaVuSans">
<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
</fo:block>
</xsl:template>
...
<xsl:template name="preface.titlepage.recto">
  <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="preface.titlepage.recto.style" margin-left="{$title.margin.left}" font-size="20pt" font-family="{$title.fontset}" font-weight="bold" text-align="left" space-after="1.0in" margin-top="1.5in">
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="appendix.titlepage.recto.style" margin-left="{$title.margin.left}" font-size="20pt" font-family="{$title.fontset}" font-weight="bold" text-align="left" space-after="1.0in" margin-top="1.5in">
<xsl:call-template name="component.title">
...
<xsl:template name="glossary.titlepage.recto">
  <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="glossary.titlepage.recto.style" margin-left="{$title.margin.left}" font-size="20pt" font-family="{$title.fontset}" font-weight="bold" text-align="left" space-after="1.0in" margin-top="1.5in">
<xsl:call-template name="component.title">
...
<xsl:template name="index.titlepage.recto">
  <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="index.titlepage.recto.style" margin-left="0pt" font-size="20pt" font-family="{$title.fontset}" font-weight="bold" text-align="left" space-after="0.25in" margin-top="0in">
<xsl:call-template name="component.title">
