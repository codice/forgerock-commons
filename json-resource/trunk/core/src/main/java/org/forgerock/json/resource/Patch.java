...
public interface Patch {
    // TODO: base on LDAP modifications API in SDK.

    /**
     * Applies the patch to the specified object.
     *
     * @param value
     *            the resource value to apply the partial change to.
     * @throws ConflictException
     *             if the patch could not be applied, given the state of the
     *             resource.
     */
    void apply(JsonValue value) throws ConflictException;
}
