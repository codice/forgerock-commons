...
import org.forgerock.jaspi.container.modules.AuthModuleManagerFactory;
...
public class AuthConfigProviderImpl implements AuthConfigProvider {
    ...
    /**
     * Get an instance of ServerAuthConfigImpl from this provider.
     *
    ...
    public ServerAuthConfig getServerAuthConfig(String layer, String appContext, CallbackHandler handler)
        ...
        serverAuthConfig = new ServerAuthConfigImpl(layer, appContext, handler);
        ((ServerAuthConfigImpl) serverAuthConfig).setAuthModuleManager(AuthModuleManagerFactory.getAuthModuleManager());
