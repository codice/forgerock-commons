...
import org.forgerock.jaspi.container.initialisation.AuthConfigProviderFileLoader;
...
public class AuthConfigFactoryImplTest {
    ...
    private AuthConfigFactoryImpl.AuthConfigProviderRegistrationIdGenerator registrationIdGenerator;
    ...
    public void setUp() throws AuthException {
        ...
        registrationIdGenerator = mock(AuthConfigFactoryImpl.AuthConfigProviderRegistrationIdGenerator.class);
