...
public class TestXacmlStringFunctions {
    ...
    static final YearMonthDuration duration3 = new YearMonthDuration(durationString3);
    ...
    static final YearMonthDuration duration4 = new YearMonthDuration(durationString4);
