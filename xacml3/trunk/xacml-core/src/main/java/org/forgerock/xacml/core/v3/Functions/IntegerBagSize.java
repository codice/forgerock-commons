 ...
 */
public class IntegerBagSize extends XACMLFunction {

    public IntegerBagSize()  {
    }
    public FunctionArgument evaluate( XACMLEvalContext pip) throws XACML3EntitlementException {
        ...
        if (!functionArgument.getType().isType(DataType.Type.XACMLINTEGERTYPE)) {
            throw new IndeterminateException("Expecting a Integer Type of Bag, but encountered a "+
