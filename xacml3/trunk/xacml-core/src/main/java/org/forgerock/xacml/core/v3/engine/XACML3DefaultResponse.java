 ...
 */
public class XACML3DefaultResponse extends Response implements Serializable {

    /**
     * Default Constructor to provide a Default Indeterminate Decision Type Status.
     */
    public XACML3DefaultResponse() {
        super();
     ...
     */
    public XACML3DefaultResponse(DecisionType decisionType) {
        super();
        Result defaultResult = new Result();
