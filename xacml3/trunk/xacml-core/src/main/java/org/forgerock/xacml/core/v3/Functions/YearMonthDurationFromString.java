 ...
 * urn:oasis:names:tc:xacml:3.0:function:yearMonthDuration-from-string
 */
public class YearMonthDurationFromString extends XACMLFunction {

    public YearMonthDurationFromString()  {
    }
    ...
    public FunctionArgument evaluate( XACMLEvalContext pip) throws XACML3EntitlementException {
        ...
        try {
            YearMonthDuration result = new YearMonthDuration(value);
            return new DataValue(DataType.XACMLYEARMONTHDURATION, result, true);
        } catch(Exception e) {
