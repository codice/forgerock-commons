 ...
 */
public class DatetimeBagSize extends XACMLFunction {

    public DatetimeBagSize()  {
    }
    public FunctionArgument evaluate( XACMLEvalContext pip) throws XACML3EntitlementException {
        ...
        if (!functionArgument.getType().isType(DataType.Type.XACMLDATETIMETYPE)) {
            throw new IndeterminateException("Expecting a Date Time Type of Bag, but encountered a "+
