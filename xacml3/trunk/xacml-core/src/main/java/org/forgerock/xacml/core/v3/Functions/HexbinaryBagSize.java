 ...
 */
public class HexbinaryBagSize extends XACMLFunction {

    public HexbinaryBagSize()  {
    }
    public FunctionArgument evaluate( XACMLEvalContext pip) throws XACML3EntitlementException {
        ...
        if (!functionArgument.getType().isType(DataType.Type.XACMLHEXBINARYTYPE)) {
            throw new IndeterminateException("Expecting a Hex Binary Type of Bag, but encountered a "+
