 ...
 *
 */
package org.forgerock.xacml.core.v3.rest;
...
import org.forgerock.xacml.core.v3.engine.XACML3IndeterminateResponse;
import org.forgerock.xacml.core.v3.engine.XACML3NotApplicableResponse;
import org.forgerock.xacml.core.v3.engine.XACMLEvalContext;
import org.forgerock.xacml.core.v3.model.*;

//import com.sun.identity.entitlement.opensso.SubjectUtils;

import org.forgerock.xacml.core.v3.resources.XACML3HomeResource;
...
public class XACML3RequestHandler {
    ...
    @Path("pdp/{appname}")
    public JAXBElement<Response> getDecision(JAXBElement<Request> req, @PathParam("appname") String appname) {
    ...
    @Produces({"application/xml", "application/xacml+xml", "application/json", "application/xacml+json"})
    @Path("dumprequest")
    public JAXBElement<Request> dumpRequest(JAXBElement<Request> req) {
        Request request = req.getValue();
        ObjectFactory objectFactory = new ObjectFactory();
