 ...
 */
public class TimeBagSize extends XACMLFunction {
    ...
    public FunctionArgument evaluate( XACMLEvalContext pip) throws XACML3EntitlementException {
        ...
        if (!functionArgument.getType().isType(DataType.Type.XACMLTIMETYPE)) {
            throw new IndeterminateException("Expecting a Time Type of Bag, but encountered a "+
