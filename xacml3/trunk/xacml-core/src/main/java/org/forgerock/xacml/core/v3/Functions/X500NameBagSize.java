 ...
 */
public class X500NameBagSize extends XACMLFunction {

    public X500NameBagSize()  {
    }
    public FunctionArgument evaluate( XACMLEvalContext pip) throws XACML3EntitlementException {
        ...
        if (!functionArgument.getType().isType(DataType.Type.XACMLX500NAMETYPE)) {
            throw new IndeterminateException("Expecting a X500Name Type of Bag, but encountered a "+
