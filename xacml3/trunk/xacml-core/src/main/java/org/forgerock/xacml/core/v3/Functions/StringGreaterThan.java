...
argument is lexicographically strictly greater than the second argument. Otherwise, it SHALL
return “False”. The comparison SHALL use Unicode codepoint collation, as defined for the
 ...
 * urn:oasis:names:tc:xacml:1.0:function:string-greater-than
 */
public class StringGreaterThan extends XACMLFunction {
