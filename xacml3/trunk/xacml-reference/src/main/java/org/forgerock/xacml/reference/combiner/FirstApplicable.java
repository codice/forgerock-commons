 ...
 */
public class FirstApplicable extends CombinerBase {
    ...
    public void register() {
        register("urn:oasis:names:tc:xacml:1.0:rule-combining-algorithm:first-applicable",this.getClass().getName());
        register("urn:oasis:names:tc:xacml:1.0:policy-combining-algorithm:first-applicable",this.getClass().getName());
    }
